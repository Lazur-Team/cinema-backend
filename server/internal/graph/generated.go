...
//go:embed "schema.graphqls" "schemas/movie.graphqls"
...
func (ec *executionContext) field_Mutation_createMovie_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNMovieInput2serverᚋinternalᚋgraphᚋmodelᚐMovieInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createMovie(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMovie2ᚖserverᚋinternalᚋgraphᚋmodelᚐMovie(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_movies(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Movie)
	fc.Result = res
	return ec.marshalNMovie2ᚕᚖserverᚋinternalᚋgraphᚋmodelᚐMovieᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_movie(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Movie)
	fc.Result = res
	return ec.marshalOMovie2ᚖserverᚋinternalᚋgraphᚋmodelᚐMovie(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputMovieInput(ctx context.Context, obj any) (model.MovieInput, error) {
	...
	fieldsInOrder := [...]string{"title", "description", "releaseYear"}
...
func (ec *executionContext) marshalNMovie2serverᚋinternalᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v model.Movie) graphql.Marshaler {
	return ec._Movie(ctx, sel, &v)
}

func (ec *executionContext) marshalNMovie2ᚕᚖserverᚋinternalᚋgraphᚋmodelᚐMovieᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Movie) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMovie2ᚖserverᚋinternalᚋgraphᚋmodelᚐMovie(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMovie2ᚖserverᚋinternalᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v *model.Movie) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNMovieInput2serverᚋinternalᚋgraphᚋmodelᚐMovieInput(ctx context.Context, v any) (model.MovieInput, error) {
...
func (ec *executionContext) marshalOMovie2ᚖserverᚋinternalᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v *model.Movie) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Movie(ctx, sel, v)
